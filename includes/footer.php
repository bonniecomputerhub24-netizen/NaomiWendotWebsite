        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
                ...
                <div class="flex flex-col gap-2">
                    <a href="<?php echo e(whatsappLink('Hello Naomi, I found your website and wanted to connect.')); ?>" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 transition-colors" style="color: #FFFDF5; font-family: 'Inter', sans-serif;" onmouseover="this.style.color='#D4A017'" onmouseout="this.style.color='#FFFDF5'">
                        ...
                        <span class="text-sm" style="font-family: 'Inter', sans-serif;"><?php echo e(WHATSAPP_DISPLAY); ?></span>
                    </a>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="<?php echo e(whatsappLink()); ?>" target="_blank" rel="noopener noreferrer" class="transition-colors text-sm" style="color: #FFFDF5; font-family: 'Inter', sans-serif;" onmouseover="this.style.color='#D4A017'" onmouseout="this.style.color='#FFFDF5'">
                            WhatsApp: <?php echo e(WHATSAPP_DISPLAY); ?>
                        </a>
                    </li>
                    <li>
