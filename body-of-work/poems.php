<?php
/**
 * Poems Page - Display all poetry content
 * Dedicated page for Naomi's heartfelt poems and poetry
 */
...
$pageTitle = 'Poems — Naomi Wendot';
$metaDescription = 'Read Naomi Wendot\'s freestyle, heartfelt poems — expressions of faith, hope, and everyday beauty.';
...
if ($search) {
    ...
    $poemsCategoryId = null;
    foreach ($categories as $cat) {
        if ($cat['slug'] === 'poems') {
            $poemsCategoryId = (int)$cat['id'];
            break;
        }
    }
    $result = getAllPosts($search, $poemsCategoryId, $page, $perPage);
} else {
    // Standard category fetch with pagination
    $result = getLatestPosts(null, 'poems', $page, $perPage);
}
...
<body class="font-century bg-cream">
    ...
    <section class="relative h-[380px] flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0">
            ...
            >
            <!-- Plum gradient overlay with reduced opacity -->
            <div class="absolute inset-0 bg-gradient-to-br from-purple-900 via-plum to-purple-800 opacity-40"></div>
        </div>
        ...
        <div class="relative z-20 text-center px-4 max-w-4xl">
            ...
            <div class="text-sm mb-6">
                ...
                <span class="text-cream text-opacity-60 mx-2">›</span>
                <span class="text-cream font-bold font-century">Poems</span>
            </div>
    ...
    <section class="bg-cream pt-14 pb-6 px-4">
        <div class="max-w-7xl mx-auto text-center">
            <p class="section-label mb-2">Poetic Reflections</p>
            <p class="text-charcoal text-sm max-w-2xl mx-auto">
                Poetry written from the heart, capturing moments of grace, wonder, and quiet reflection on faith and life.
            </p>
            ...
            <form method="get" action="" class="max-w-xl mx-auto">
                ...
                <?php if ($search): ?>
                    <div class="text-center mt-3">
                        ...
                        <a href="poems.php" class="ml-2 text-sm text-gold hover:underline">Clear search</a>
                    </div>
                <?php endif; ?>
            </form>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            <?php if (!empty($poems)): ?>
                ...
                <div class="mb-6 text-center">
                    <p class="text-sm text-gray-600">
                        Showing <?php echo count($poems); ?> of <?php echo $totalPosts; ?> poem<?php echo $totalPosts !== 1 ? 's' : ''; ?>
                            ...
                            <?php if ($isHandwritten || $poem['featured_image']): ?>
                                <div class="blog-card-img">
                                    <a href="<?php echo $postUrl; ?>">
                                        <img 
                                            src="<?php echo basePath() . ($poem['handwritten_image'] ?? $poem['featured_image']); ?>" 
            ...
            <?php else: ?>
                ...
                <div class="text-center py-20">
                    ...
                    <?php if ($search): ?>
                        <p class="text-gray-500 text-lg mb-2">No poems found for "<?php echo htmlspecialchars($search); ?>"</p>
                        <a href="poems.php" class="text-gold hover:underline">View all poems</a>
                    <?php else: ?>
                        <p class="text-gray-500 text-lg mb-2">No poems available yet</p>
                        <p class="text-gray-400 text-sm">Check back soon for inspiring poetry!</p>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="max-w-4xl mx-auto text-center">
            <div class="bg-gradient-to-br from-plum to-purple-900 rounded-2xl p-8 md:p-12 text-white">
                ...
                <p class="text-gold text-lg mb-6">
                    Subscribe to get notified when new poems are published
                </p>
