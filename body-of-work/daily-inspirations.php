<?php
/**
 * Daily Inspirations Page - Display all daily inspiration content
 * Dedicated page for Naomi's daily inspirational messages
 */
...
$pageTitle = 'Daily Inspirations — Naomi Wendot';
$metaDescription = 'Read Naomi Wendot\'s daily inspirational messages — short, Holy Spirit-inspired words to start your day with hope.';

// Pagination
$page = isset($_GET['page']) ? max(1, (int)$_GET['page']) : 1;
$perPage = 12;

// Search within daily inspirations
$search = isset($_GET['q']) ? trim($_GET['q']) : '';

// Get daily inspirations with pagination
if ($search) {
    // If searching, use getAllPosts with category filter
    $categories = getCategories();
    $inspirationsCategoryId = null;
    foreach ($categories as $cat) {
        if ($cat['slug'] === 'daily-inspirations') {
            $inspirationsCategoryId = (int)$cat['id'];
            break;
        }
    }
    $result = getAllPosts($search, $inspirationsCategoryId, $page, $perPage);
} else {
    // Standard category fetch with pagination
    $result = getLatestPosts(null, 'daily-inspirations', $page, $perPage);
}

$inspirations = $result['posts'];
...
<body class="font-century bg-cream">
    ...
    <section class="relative h-[380px] flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img 
                src="https://images.unsplash.com/photo-1504805572947-34fad45aed93?w=1600&q=80" 
                alt="Morning light and inspiration" 
                class="w-full h-full object-cover"
            >
            <!-- Amber-plum gradient overlay with reduced opacity -->
            <div class="absolute inset-0 bg-gradient-to-br from-amber-800 via-orange-900 to-plum opacity-45"></div>
        </div>
        ...
        <div class="relative z-20 text-center px-4 max-w-4xl">
            ...
            <div class="text-sm mb-6">
                ...
                <span class="text-cream text-opacity-60 mx-2">›</span>
                <span class="text-cream font-bold font-century">Daily Inspirations</span>
            </div>
    ...
    <section class="bg-cream pt-14 pb-6 px-4">
        <div class="max-w-7xl mx-auto text-center">
            <p class="section-label mb-2">Daily Encouragement</p>
            <p class="text-charcoal text-sm max-w-2xl mx-auto">
                Bite-sized reminders of God's love, grace, and presence — perfect for your morning quiet time.
            </p>
            ...
            <form method="get" action="" class="max-w-xl mx-auto">
                ...
                <?php if ($search): ?>
                    <div class="text-center mt-3">
                        ...
                        <a href="daily-inspirations.php" class="ml-2 text-sm text-gold hover:underline">Clear search</a>
                    </div>
                <?php endif; ?>
            </form>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            <?php if (!empty($inspirations)): ?>
                ...
                <div class="mb-6 text-center">
                    <p class="text-sm text-gray-600">
                        Showing <?php echo count($inspirations); ?> of <?php echo $totalPosts; ?> inspiration<?php echo $totalPosts !== 1 ? 's' : ''; ?>
                            ...
                            <?php if ($isHandwritten || $inspiration['featured_image']): ?>
                                <div class="blog-card-img">
                                    <a href="<?php echo $postUrl; ?>">
                                        <img 
                                            src="<?php echo basePath() . ($inspiration['handwritten_image'] ?? $inspiration['featured_image']); ?>" 
            ...
            <?php else: ?>
                ...
                <div class="text-center py-20">
                    ...
                    <?php if ($search): ?>
                        <p class="text-gray-500 text-lg mb-2">No inspirations found for "<?php echo htmlspecialchars($search); ?>"</p>
                        <a href="daily-inspirations.php" class="text-gold hover:underline">View all inspirations</a>
                    <?php else: ?>
                        <p class="text-gray-500 text-lg mb-2">No daily inspirations available yet</p>
                        <p class="text-gray-400 text-sm">Check back soon for daily encouragement!</p>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="max-w-4xl mx-auto text-center">
            <div class="bg-gradient-to-br from-plum to-purple-900 rounded-2xl p-8 md:p-12 text-white">
                ...
                <p class="text-gold text-lg mb-6">
                    Subscribe to get daily inspiration delivered to your inbox
                </p>
